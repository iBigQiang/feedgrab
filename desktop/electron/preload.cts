...
import type { FeedgrabIpcApi, FeedgrabWorkerEvent, FetchRequest } from "./ipc-types.js";
...
const api: FeedgrabIpcApi = {
  ...
  loginStatus: () =>
    ipcRenderer.invoke("feedgrab:loginStatus") as ReturnType<FeedgrabIpcApi["loginStatus"]>,
