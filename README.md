...
- Windows 安装包直链：[feedgrab-desktop-setup-0.1.0.exe](https://github.com/iBigQiang/feedgrab/releases/download/desktop-v0.1.0-20260627/feedgrab-desktop-setup-0.1.0.exe)
- 发布页：[desktop-v0.1.0-20260627](https://github.com/iBigQiang/feedgrab/releases/tag/desktop-v0.1.0-20260627)
...
| 文件 | 适合对象 | 说明 |
| --- | --- | --- |
| `feedgrab-desktop-setup-0.1.0.exe` | 普通用户 | 双击安装，自动创建开始菜单和桌面快捷方式。 |

本次安装包来自 `feedgrab-desktop` 分支，打包时间 / 构建时间 `2026-06-27 21:58`，签名状态：未签名。本地文件 SHA256：
...
1. 从 GitHub Releases 下载 `feedgrab-desktop-setup-0.1.0.exe`。
2. 双击安装包，按提示选择安装目录。
